    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm sticky-top">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center gap-2" href="index.html">
                ...
                <span class="text-primary fw-bold"><a  href="index.html">Yoonnie Handmade</a></span>
            </a>
                ...
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item ms-lg-3">
                        <a class="btn btn-outline-primary rounded-pill px-4" href="carrito.html">
                            <img href="https://img.icons8.com/?size=100&id=44050&format=png&color=000000"> <span id="cart-count">0</span>
                        </a>
                    </li>
                </ul>
            </div>
